...
def agent_pod_get(
    ...
    validator_signing_key: str = typer.Option(..., "--signing-key", envvar="PROXION_SIGNING_KEY", help="Validator HMAC signing key (hex). Prefer the PROXION_SIGNING_KEY env var; a flag is visible in ps/shell history."),
    aud: str = typer.Option("", "--aud"),
